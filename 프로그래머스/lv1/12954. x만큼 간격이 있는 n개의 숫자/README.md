...
- 배열(혹은 리스트) 에서 더하는 것은, list.append() 하면 된다.
- 파이썬에서 배열과 리스트를 구분... 하는 것이 알고리즘 풀이에 있어서 거의 의미가 없다시피 한다고 한다. 
        - ChatGPT 피셜이긴 한데, 너무 기본적인 내용을 물어보는 것이므로 신빙성을 가진다고 간주하고 받아들이자.
