...
- 거꾸로도 그리디를 할 수 있다. 굳이 처음부터 돌아야 한다는 생각을 하지 말자. 
- 생각보다 그리디 알고리즘이라는 문제 자체가, 실마리를 찾아야 풀 만한 문제가 많은 것 같다. 그냥 아직 완벽히 감을 잡은 것 같지는 않다. 조금 더 많이 풀어 보자.
