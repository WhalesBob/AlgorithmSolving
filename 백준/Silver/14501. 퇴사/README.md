...
- 역시 코드 전체적인 건 맞는데, 코드 내에서 가까운 곳에 반례가 있었다. 조금만 고치면 되는 케이스
- 단, 반성해야 하는 점은 생각한 점을 정말 꼼꼼하게 고쳐야 한다는 것이다. 문자 하나도 허투루 그냥 넘겨짚어서 쓰지 않도록 하자. 생각한 부분이 맞았는데도 불구하고 헤매면 시간이 아깝다.
